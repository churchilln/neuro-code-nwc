function a = appcoef_parallel(c,l,varargin)
...
% Initialization. - refer to bookkeeping vector!!
a = c(1:l(1),:);

% Iterated reconstruction.
imax = rmax+1;
for p = nmax:-1:n+1
    d = detcoef_parallel(c,l,p);                         % extract detail [HHHEEERRREEEEE!!!]
    a = idwt_parallel(a,d,Lo_R,Hi_R,l(imax-p));
end
