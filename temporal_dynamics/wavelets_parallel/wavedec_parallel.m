function [c,l] = wavedec_parallel(x,n,IN3,IN4)
%
% DONE??
%
...
for k = 1:n
    [x,d] = dwt_parallel(x,Lo_D,Hi_D); % decomposition
    c     = [d; c];            % store detail
    l     = [size(d,1); l];    % store length
end

% Last approximation.
c = [x; c];            % matrix of appx. / detail coefficients
l = [size(x,1); l];    % vector showing length of structures...
