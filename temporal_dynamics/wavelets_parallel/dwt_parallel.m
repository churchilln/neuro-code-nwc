function [a,d] = dwt_parallel(x,varargin)
%
% DONE - just make sure you are trasnfoming COLUMNS of x!!!
%
...
y = wextend('ar',dwtEXTM,x,lenEXT);

% Compute coefficients of approximation.
z = wconv1_parallel(y,Lo_D,'valid'); 
a = z(first:2:last,:);

% Compute coefficients of detail.
z = wconv1_parallel(y,Hi_D,'valid'); 
d = z(first:2:last,:);
