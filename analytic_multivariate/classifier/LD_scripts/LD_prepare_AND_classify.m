function [ output ] = LD_prepare_AND_classify( data_trn, data_tst, REF_IMG, labels, data_HELD, labels_HELD, Range, RangeVal2, regtype)
% *corrected
...
if( strcmp(regtype,'L1') )
    ...
    % classify
    [accur_1] = LD_classify_set (model_trn, data_trn, trn_avg, data_HELD, labels_HELD);
    [accur_2] = LD_classify_set (model_tst, data_tst, tst_avg, data_HELD, labels_HELD);
    % prediction
...
elseif( strcmp(regtype,'PC') )
    ...
    % classify 
    [accur_1] = LD_classify_set (model_trn, trn_u(:,1:Range), trn_avg, data_tst, labels);
    [accur_2] = LD_classify_set (model_tst, tst_u(:,1:Range), tst_avg, data_trn, labels);
    %
    PP = (accur_1 + accur_2)./2;
    
    % classify 
    [accur_1] = LD_classify_set (model_trn, trn_u(:,1:Range), trn_avg, data_HELD, labels_HELD);
    [accur_2] = LD_classify_set (model_tst, tst_u(:,1:Range), tst_avg, data_HELD, labels_HELD);
    %
    GG = (accur_1 + accur_2)./2;
...
elseif(  strcmp(regtype,'IC') )
    ...
    % classify 
    [accur_1] = LD_classify_set (model_trn, trn_u_ic(:,1:Range), trn_avg, data_tst, labels);
    [accur_2] = LD_classify_set (model_tst, tst_u_ic(:,1:Range), tst_avg, data_trn, labels);
    %
    PP = (accur_1 + accur_2)./2;  
    
    % classify 
    [accur_1] = LD_classify_set (model_trn, trn_u_ic(:,1:Range), trn_avg, data_HELD, labels_HELD);
    [accur_2] = LD_classify_set (model_tst, tst_u_ic(:,1:Range), tst_avg, data_HELD, labels_HELD);
    %
    GG = (accur_1 + accur_2)./2;       
end
