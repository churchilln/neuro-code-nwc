function allright = LR_L1_run2 (cond1, cond2, subBLK)
% clear;
% close all;
% cond1=3;
% cond2=5;
...
for (subj_idx=1:18)
    ...
    model_all = LR_L12_create (all_K, Label_full,'L1', Range);
...
%% LD-PC, 4x20 blocks (LVL 111)
    ...
    for split = 1:n_splits
        ...
        for(swap=1:2)
            ...
            model_trn = LR_L12_create (trn_K, Label_splt,'L1', Range);
            ...
            model_tst = LR_L12_create (tst_K, Label_splt,'L1', Range);
        ...
        save(strcat('LR_L1_sub',num2str(subBLK),'alt_C',num2str(10*cond1+cond2),'_subj_',num2str(subj_idx),'_',num2str(split),'.mat'),...
