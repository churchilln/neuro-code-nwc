function QD = QD_L1_train (data, labels, FirstLim, Range)
% Quaddo
...
LAMBDA = linspace( -10, -1, RangeGLASSO );
LAMBDA = exp( LAMBDA );

% (2-3) init
QD.inv_cov0all = cell(RangeGLASSO,1);
QD.inv_cov1all = cell(RangeGLASSO,1);
%
QD.logdet0all = zeros(RangeGLASSO,1);
QD.logdet1all = zeros(RangeGLASSO,1);
