function [ output ] = QD_prepare_AND_classify_PP( data_trn, data_tst, REF_IMG, labels, data_HELD, labels_HELD, Range, RangeVal2, regtype, mask )
%
...
if( strcmp(regtype,'L1') )
    ...
    [accur_1] = QD_classify_PP (model_trn, data_trn, trn_avg, data_tst, labels,'L1');        
    [accur_2] = QD_classify_PP (model_tst, data_tst, tst_avg, data_trn, labels,'L1');        
    % prediction
    PP = (accur_1 + accur_2)./2;
    
    % classify test data using training model
    [accur_1] = QD_classify_PP (model_trn, data_trn, trn_avg, data_HELD, labels_HELD,'L1');        
    [accur_2] = QD_classify_PP (model_tst, data_tst, tst_avg, data_HELD, labels_HELD,'L1');        
    % prediction
...
elseif( strcmp(regtype,'L2') )
    ...
    % classify test data using training model
    [accur_1] = QD_classify_PP (model_trn, data_trn, trn_avg, data_tst, labels,'L2');        
    [accur_2] = QD_classify_PP (model_tst, data_tst, tst_avg, data_trn, labels,'L2');        
    % prediction
    PP = (accur_1 + accur_2)./2;
    
    % classify test data using training model
    [accur_1] = QD_classify_PP (model_trn, data_trn, trn_avg, data_HELD, labels_HELD,'L2');        
    [accur_2] = QD_classify_PP (model_tst, data_tst, tst_avg, data_HELD, labels_HELD,'L2');        
    % prediction
    GG = (accur_1 + accur_2)./2;
...
elseif( strcmp(regtype,'PC') )
    ...
    % classify test data using training model
    [accur_1] = QD_classify_PP (model_trn, trn_u(:,1:Range), trn_avg, data_tst, labels,'NR');        
    [accur_2] = QD_classify_PP (model_tst, tst_u(:,1:Range), tst_avg, data_trn, labels,'NR');        
    %
    PP = (accur_1 + accur_2)./2;
    
    % classify test data using training model
    [accur_1] = QD_classify_PP (model_trn, trn_u(:,1:Range), trn_avg, data_HELD, labels_HELD,'NR');        
    [accur_2] = QD_classify_PP (model_tst, tst_u(:,1:Range), tst_avg, data_HELD, labels_HELD,'NR');        
    %
    GG = (accur_1 + accur_2)./2;
...
elseif(  strcmp(regtype,'IC') )
    ...
    % classify 
    [accur_1] = QD_classify_PP (model_trn, trn_u_ic(:,1:Range), trn_avg, data_tst, labels,'NR');        
    [accur_2] = QD_classify_PP (model_tst, tst_u_ic(:,1:Range), tst_avg, data_trn, labels,'NR');        
    %
    PP = (accur_1 + accur_2)./2;
    
    % classify 
    [accur_1] = QD_classify_PP (model_trn, trn_u_ic(:,1:Range), trn_avg, data_HELD, labels_HELD,'NR');        
    [accur_2] = QD_classify_PP (model_tst, tst_u_ic(:,1:Range), tst_avg, data_HELD, labels_HELD,'NR');        
    %
    GG = (accur_1 + accur_2)./2;
