function [ output ] = LD_prepare_AND_classify_ext( data_trn, data_tst, REF_IMG, labels, data_HELD, labels_HELD, Range, Curt, regtype)
% *corrected
...
if( strcmp(regtype,'PCL1') )
    ...
    % classify
    [accur_1] = LD_classify_set (model_trn, trn_u, trn_avg, data_HELD, labels_HELD);
    [accur_2] = LD_classify_set (model_tst, tst_u, tst_avg, data_HELD, labels_HELD);
    % prediction
