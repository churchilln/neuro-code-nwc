...
for( no = 1 )
   ...
   % validation matrices
    ...
    XX1_val = XX1;
    % test matrix
    nh0 = round(size(XX0,2)./2);
    nh1 = round(size(XX1,2)./2);
...
%%  %% inner prediction loop
    for( ni = 1:Nin ) 
        ...
        % get index
        a=randperm(N0); i0_sp1 = a(1:nh0); i0_sp2 = a(nh0+1:end);
        a=randperm(N1); i1_sp1 = a(1:nh1); i1_sp2 = a(nh1+1:end);
        % design matrices
